...
namespace CocosSharpMathGame
{
    ...
    internal abstract class VerticalScalingButton : UIElementNode
    {
        ...
        VerticalScalingButton(string texName1, string texName2, string texName3)
        {
        ...
        private protected void UpdateSpritePlacement()
        {
            ...
            MiddleSprite.Position = new CCPoint(0, StartSprite.ContentSize.Height);
            EndSprite.Position = new CCPoint(0, MiddleSprite.Position.Y + MiddleSprite.ScaleY);
            ContentSize = new CCSize(EndSprite.ContentSize.Width, EndSprite.PositionY + EndSprite.ContentSize.Height);
        }
